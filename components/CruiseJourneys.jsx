...
export default function CruiseJourneys() {
  ...
  return (
    <section id="cruise-journeys" className="bg-[#f7f8fc] px-4 py-14 md:px-10" style={{ backgroundImage: "url('/background.jpg')", backgroundRepeat: 'repeat', backgroundSize: 'auto', backgroundPosition: '0 0' }}>

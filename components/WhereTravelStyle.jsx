export default function WhereTravelStyle() {
  return (
    <div id="where-travel-style" className="bg-[#f4f5f7] py-14 sm:py-20 px-4 sm:px-6">
      <div className="text-center max-w-[85.2vw] mx-auto">
        <p className="text-xl sm:text-2xl font-taprom text-[#2C3078] mb-1 tracking-wide">
          our origin story
        </p>
        ...
        <div className="space-y-5 text-[15px] sm:text-lg text-[#2C3078] leading-7">
          <p className="mx-auto max-w-[90vw] sm:max-w-[60vw]">
            We started from a simple observation: travel should be a respite.
            But for most people, planning it is anything but.
          </p>

          <p className="mx-auto max-w-[90vw] sm:max-w-[55vw]">
        ...
        <p className="text-[15px] sm:text-lg text-[#2C3078] max-w-[90vw] sm:max-w-[35vw] mx-auto leading-6">

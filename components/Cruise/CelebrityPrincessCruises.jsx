...
const cruises = [
  { title: "BAHAMAS", nights: "3 Nights", route: "Round Trip | Port Canaveral, FL", price: "$X", image: "/Hourse.png" },
      ...
      <div className="sm:hidden">
        ...
        <div className="mt-6 flex items-center justify-between gap-8">
          <button
            ...
            className="shrink-0 text-4xl text-[#3b1c8e] hover:opacity-70 transition"
          >
            ←
          </button>
          <button
